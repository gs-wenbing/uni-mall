	...
	<view class="container">
		...
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box"><image class="portrait" :src="userInfo.HeadImageUrl || '/static/missing-face.png'"></image></view>
				<view class="info-box">
		...
		<view class="cover-container">
			...
			<view class="history-section icon">
				<view class="sec-header"><text class="sec-header-t">我的订单</text></view>
