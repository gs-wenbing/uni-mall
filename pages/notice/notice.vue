	...
	<view>
		<view class="notice-item">
			...
			<view class="content">
				...
				<view class="img-wrapper">
					<image class="pic" src="http://res.genvana.cn/upload/goods/201812060536101015.jpg"></image>
				</view>
		...
		<view class="notice-item">
			...
			<view class="content">
				<text class="title">新品上市，全场满199减50</text>
				<view class="img-wrapper">
					<image class="pic" src="http://res.genvana.cn/upload/goods/201904251034591934.jpg"></image>
					<view class="cover">
						活动结束
					</view>
				</view>
		...
		<view class="notice-item">
			...
			<view class="content">
				<text class="title">新品上市，全场满199减50</text>
				<view class="img-wrapper">
					<image class="pic" src="http://res.genvana.cn/upload/goods/201810250504045724.jpg"></image>
					<view class="cover">
						活动结束
					</view>
				</view>
