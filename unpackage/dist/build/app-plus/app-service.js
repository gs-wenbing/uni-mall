...
var x=['./components/city-selector.wxml','./components/uni-load-more/uni-load-more.wxml','./components/uni-number-box.wxml','./pages/address/address.wxml','./pages/address/addressEdit.wxml','./pages/login/login.wxml','./pages/notice/notice.wxml','./pages/order/placeOrder.wxml','./pages/pay/pay.wxml','./pages/pay/paySuccess.wxml','./pages/product/detail.wxml','./pages/product/list.wxml','./pages/search/search.wxml','./pages/setting/setting.wxml','./pages/tabBar/cart.wxml','./pages/tabBar/category.wxml','./pages/tabBar/home.wxml'];d_[x[0]]={}
...
var eTB=_mz(z,'uni-number-box',['bind:__l',9,'bind:eventChange',1,'class',2,'data-event-opts',3,'index',4,'isMax',5,'isMin',6,'max',7,'min',8,'value',9,'vueId',10],[],lQB,oPB,gg)
_(aRB,eTB)
return aRB
}
oNB.wxXCkey=4
_2z(z,7,cOB,e,s,gg,oNB,'item','index','GoodsID')
}
oJB.wxXCkey=1
oJB.wxXCkey=3
_(r,xIB)
...
var z=gz$gwx_16()
var oVB=_mz(z,'scroll-view',['scrollWithAnimation',-1,'scrollY',-1,'bindscroll',0,'class',1,'data-event-opts',1,'scrollTop',2],[],e,s,gg)
var xWB=_v()
_(oVB,xWB)
...
var b9B=_v()
_(t7B,b9B)
if(_oz(z,12,a6B,l5B,gg)){b9B.wxVkey=1
}
b9B.wxXCkey=1
return t7B
}
c3B.wxXCkey=2
_2z(z,10,o4B,cZB,fYB,gg,c3B,'child','index','id')
return h1B
}
xWB.wxXCkey=2
_2z(z,6,oXB,e,s,gg,xWB,'item','__i1__','GoodsClassID')
_(r,oVB)
return r
}
...
__wxAppCode__['pages/tabBar/cart.json']={"navigationBarTitleText":"购物车","usingComponents":{"uni-number-box":"/components/uni-number-box"}};
__wxAppCode__['pages/tabBar/cart.wxml']=$gwx('./pages/tabBar/cart.wxml');

__wxAppCode__['pages/tabBar/category.json']={"navigationBarTitleText":"分类","bounce":"none","titleNView":{"buttons":[{"fontSrc":"/static/mallicon.ttf","text":"","fontSize":"28","color":"#ffffff","background":"rgba(0,0,0,0)","redDot":true}]},"usingComponents":{}};
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/tabBar/category"],{"4af6":function(t,n,e){"use strict";(function(t){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var a=i(e("a34a"));e("2f62");function i(t){return t&&t.__esModule?t:{default:t}}function o(t,n,e,a,i,o,s){try{var r=t[o](s),c=r.value}catch(u){return void e(u)}r.done?n(c):Promise.resolve(c).then(a,i)}function s(t){return function(){var n=this,e=arguments;return new Promise(function(a,i){var s=t.apply(n,e);function r(t){o(s,a,i,r,c,"next",t)}function c(t){o(s,a,i,r,c,"throw",t)}r(void 0)})}}var r={data:function(){return{sizeCalcState:!1,tabScrollTop:0,currentId:1,fatherlist:[],sonlist:[],tlist:[]}},onLoad:function(){this.loadData()},methods:{loadData:function(){var t=s(a.default.mark(function t(){var n;return a.default.wrap(function(t){while(1)switch(t.prev=t.next){case 0:return t.next=2,this.$api.callApix({param:"",action:"home/getGoodsClass"});case 2:n=t.sent,n.IsSuccess&&this.analysisData(n.data);case 4:case"end":return t.stop()}},t,this)}));function n(){return t.apply(this,arguments)}return n}(),analysisData:function(t){var n=this;this.currentId=t[0].GoodsClassID,t.forEach(function(t){t.children&&0==t.IsVisible&&(n.fatherlist.push(t),n.sonlist.push(t),t.children.forEach(function(t){0==t.IsVisible&&n.tlist.push(t)}))})},onImageLoad:function(t,n){this.$set(this[t][n],"loaded","loaded")},onImageError:function(t,n){this[t][n].PicURL="/static/errorImage.jpg"},tabtap:function(t){this.sizeCalcState||this.calcSize(),this.currentId=t.GoodsClassID;var n=this.sonlist.findIndex(function(n){return n.GoodsClassID===t.GoodsClassID});this.tabScrollTop=this.sonlist[n].top},asideScroll:function(t){this.sizeCalcState||this.calcSize();var n=t.detail.scrollTop,e=this.sonlist.filter(function(t){return t.top<=n}).reverse();e.length>0&&(this.currentId=e[0].GoodsClassID)},calcSize:function(){var n=0;this.sonlist.forEach(function(e){var a=t.createSelectorQuery().select("#main-"+e.GoodsClassID);a.fields({size:!0},function(t){e.top=n,n+=t.height,e.bottom=n}).exec()}),this.sizeCalcState=!0},navToList:function(n,e){t.navigateTo({url:"/pages/product/list?fid=".concat(this.currentId,"&sid=").concat(n,"&tid=").concat(e)})}},onNavigationBarButtonTap:function(n){var e=n.index,a=getCurrentPages(),i=a[a.length-1],o=i.$getAppWebview();o.hideTitleNViewButtonRedDot({index:e}),t.navigateTo({url:"/pages/notice/notice"})}};n.default=r}).call(this,e("6e42")["default"])},"5be0":function(t,n,e){},"7ded":function(t,n,e){"use strict";e.r(n);var a=e("4af6"),i=e.n(a);for(var o in a)"default"!==o&&function(t){e.d(n,t,function(){return a[t]})}(o);n["default"]=i.a},a2d4:function(t,n,e){"use strict";var a=e("5be0"),i=e.n(a);i.a},c244:function(t,n,e){"use strict";var a=function(){var t=this,n=t.$createElement;t._self._c},i=[];e.d(n,"a",function(){return a}),e.d(n,"b",function(){return i})},fbef:function(t,n,e){"use strict";e.r(n);var a=e("c244"),i=e("7ded");for(var o in i)"default"!==o&&function(t){e.d(n,t,function(){return i[t]})}(o);e("a2d4");var s=e("2877"),r=Object(s["a"])(i["default"],a["a"],a["b"],!1,null,null,null);n["default"]=r.exports}},[["f964","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/tabBar/cart"],{"0f14":function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=c(n("a34a")),r=n("2f62");function c(t){return t&&t.__esModule?t:{default:t}}function i(t,e,n,a,r,c,i){try{var o=t[c](i),u=o.value}catch(s){return void n(s)}o.done?e(u):Promise.resolve(u).then(a,r)}function o(t){return function(){var e=this,n=arguments;return new Promise(function(a,r){var c=t.apply(e,n);function o(t){i(c,a,r,o,u,"next",t)}function u(t){i(c,a,r,o,u,"throw",t)}o(void 0)})}}function u(t){for(var e=1;e<arguments.length;e++){var n=null!=arguments[e]?arguments[e]:{},a=Object.keys(n);"function"===typeof Object.getOwnPropertySymbols&&(a=a.concat(Object.getOwnPropertySymbols(n).filter(function(t){return Object.getOwnPropertyDescriptor(n,t).enumerable}))),a.forEach(function(e){s(t,e,n[e])})}return t}function s(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}var l=function(){return n.e("components/uni-number-box").then(n.bind(null,"1318"))},f={components:{uniNumberBox:l},data:function(){return{total:0,allChecked:!1,empty:!1,cartList:[]}},onLoad:function(){this.loadData()},watch:{cartList:function(t){var e=0===t.length;this.empty!==e&&(this.empty=e)}},computed:u({},(0,r.mapState)(["hasLogin"]),{cartNum:function(){var t=this.cartList,e=0;return t.forEach(function(t){!0===t.checked&&e++}),e}}),methods:{loadData:function(){var t=o(a.default.mark(function t(){var e,n;return a.default.wrap(function(t){while(1)switch(t.prev=t.next){case 0:return t.next=2,this.$api.callApix({param:"",action:"home/getCartList"});case 2:e=t.sent,n=[],e.IsSuccess&&(n=e.data.map(function(t){return t.checked=!0,t})),this.cartList=n,this.calcTotal();case 7:case"end":return t.stop()}},t,this)}));function e(){return t.apply(this,arguments)}return e}(),onImageLoad:function(t,e){this.$set(this[t][e],"loaded","loaded")},onImageError:function(t,e){this[t][e].DefaultPicURL="/static/errorImage.jpg"},navToLogin:function(){t.navigateTo({url:"/pages/login/login"})},check:function(t,e){if("item"===t)this.cartList[e].checked=!this.cartList[e].checked;else{var n=!this.allChecked,a=this.cartList;a.forEach(function(t){t.checked=n}),this.allChecked=n}this.calcTotal(t)},numberChange:function(t){this.cartList[t.index].CartNum=t.CartNum,this.calcTotal()},deleteCartItem:function(e){var n=this.cartList,a=n[e];a.GoodsID;this.cartList.splice(e,1),this.calcTotal(),t.hideLoading()},clearCart:function(){var e=this;t.showModal({content:"清空购物车？",success:function(t){t.confirm&&(e.cartList=[])}})},calcTotal:function(){var t=this.cartList;if(0!==t.length){var e=0,n=!0;t.forEach(function(t){!0===t.checked?e+=Number(t.Price)*Number(t.CartNum):!0===n&&(n=!1)}),this.allChecked=n,this.total=Number(e.toFixed(2))}else this.empty=!0},createOrder:function(){var e=this.cartList,n=[];e.forEach(function(t){t.checked&&n.push(t)}),t.navigateTo({url:"/pages/order/placeOrder?data=".concat(this.$api.putExtra(n))})}}};e.default=f}).call(this,n("6e42")["default"])},1689:function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},r=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return r})},aa9d:function(t,e,n){"use strict";var a=n("b8a5"),r=n.n(a);r.a},b8a5:function(t,e,n){},bc76:function(t,e,n){"use strict";n.r(e);var a=n("0f14"),r=n.n(a);for(var c in a)"default"!==c&&function(t){n.d(e,t,function(){return a[t]})}(c);e["default"]=r.a},bfce:function(t,e,n){"use strict";n.r(e);var a=n("1689"),r=n("bc76");for(var c in r)"default"!==c&&function(t){n.d(e,t,function(){return r[t]})}(c);n("aa9d");var i=n("2877"),o=Object(i["a"])(r["default"],a["a"],a["b"],!1,null,null,null);e["default"]=o.exports}},[["f6ab","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/setting/setting"],{"3b8a":function(t,n,e){"use strict";e.r(n);var o=e("d12b"),u=e.n(o);for(var r in o)"default"!==r&&function(t){e.d(n,t,function(){return o[t]})}(r);n["default"]=u.a},4462:function(t,n,e){"use strict";e.r(n);var o=e("f835"),u=e("3b8a");for(var r in u)"default"!==r&&function(t){e.d(n,t,function(){return u[t]})}(r);e("adbb");var a=e("2877"),c=Object(a["a"])(u["default"],o["a"],o["b"],!1,null,null,null);n["default"]=c.exports},ad9d:function(t,n,e){},adbb:function(t,n,e){"use strict";var o=e("ad9d"),u=e.n(o);u.a},d12b:function(t,n,e){"use strict";(function(t){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var o=e("2f62");function u(t){for(var n=1;n<arguments.length;n++){var e=null!=arguments[n]?arguments[n]:{},o=Object.keys(e);"function"===typeof Object.getOwnPropertySymbols&&(o=o.concat(Object.getOwnPropertySymbols(e).filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable}))),o.forEach(function(n){r(t,n,e[n])})}return t}function r(t,n,e){return n in t?Object.defineProperty(t,n,{value:e,enumerable:!0,configurable:!0,writable:!0}):t[n]=e,t}var a={data:function(){return{}},methods:u({},(0,o.mapMutations)(["logout"]),{navTo:function(n){t.navigateTo({url:n})},toLogout:function(){var n=this;t.showModal({content:"确定要退出登录么",success:function(e){e.confirm&&(n.logout(),setTimeout(function(){t.navigateBack()},200))}})}})};n.default=a}).call(this,e("6e42")["default"])},f835:function(t,n,e){"use strict";var o=function(){var t=this,n=t.$createElement;t._self._c},u=[];e.d(n,"a",function(){return o}),e.d(n,"b",function(){return u})}},[["26a9","common/runtime","common/vendor"]]]);
});
