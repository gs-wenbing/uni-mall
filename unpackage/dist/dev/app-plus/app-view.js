...
Z([3,'back'])
Z([3,'off'])
Z([3,'width:400rpx;height:300rpx;'])
Z([3,'预览'])
Z([3,'widthFix'])
Z([[7],[3,'src']])
...
var x=['./components/city-selector.wxml','./components/uni-load-more/uni-load-more.wxml','./components/uni-number-box.wxml','./pages/address/address.wxml','./pages/address/addressEdit.wxml','./pages/login/login.wxml','./pages/notice/notice.wxml','./pages/order/placeOrder.wxml','./pages/pay/pay.wxml','./pages/pay/paySuccess.wxml','./pages/product/detail.wxml','./pages/product/list.wxml','./pages/search/search.wxml','./pages/setting/about.wxml','./pages/setting/setting.wxml','./pages/tabBar/home.wxml'];d_[x[0]]={}
...
var z=gz$gwx_14()
var oHR=_n('view')
var fIR=_mz(z,'button',['bindtap',0,'data-event-opts',1,'type',1],[],e,s,gg)
var cJR=_oz(z,3,e,s,gg)
_(fIR,cJR)
_(oHR,fIR)
var hKR=_mz(z,'camera',['binderror',4,'data-event-opts',1,'devicePosition',2,'flash',3,'style',4],[],e,s,gg)
_(oHR,hKR)
var oLR=_n('view')
var cMR=_oz(z,9,e,s,gg)
_(oLR,cMR)
_(oHR,oLR)
var oNR=_mz(z,'image',['mode',10,'src',1],[],e,s,gg)
_(oHR,oNR)
_(r,oHR)
return r
}
...
var tQR=_mz(z,'view',['bindtap',1,'class',1,'data-event-opts',2,'hoverClass',3,'hoverStayTime',4],[],e,s,gg)
var eRR=_n('text')
...
_(tQR,oTR)
_(aPR,tQR)
var xUR=_mz(z,'view',['bindtap',9,'class',1,'data-event-opts',2,'hoverClass',3,'hoverStayTime',4],[],e,s,gg)
var oVR=_n('text')
...
_(xUR,cXR)
_(aPR,xUR)
var hYR=_mz(z,'view',['bindtap',17,'class',1,'data-event-opts',2,'hoverClass',3,'hoverStayTime',4],[],e,s,gg)
var oZR=_n('text')
...
_(hYR,o2R)
_(aPR,hYR)
var l3R=_mz(z,'view',['bindtap',25,'class',1,'data-event-opts',2,'hoverClass',3,'hoverStayTime',4],[],e,s,gg)
var a4R=_n('text')
...
_(l3R,e6R)
_(aPR,l3R)
var b7R=_mz(z,'view',['bindtap',33,'class',1,'data-event-opts',2,'hoverClass',3,'hoverStayTime',4],[],e,s,gg)
var o8R=_n('text')
...
_(b7R,o0R)
_(aPR,b7R)
var fAS=_mz(z,'view',['bindtap',41,'class',1,'data-event-opts',2,'hoverClass',3,'hoverStayTime',4],[],e,s,gg)
var cBS=_n('text')
...
_(cES,eJS)
_(aPR,cES)
var bKS=_mz(z,'view',['bindtap',55,'class',1,'data-event-opts',2],[],e,s,gg)
var oLS=_n('text')
...
_(cPS,hQS)
var oRS=_mz(z,'view',['class',3,'style',1],[],e,s,gg)
_(cPS,oRS)
var cSS=_mz(z,'swiper',['circular',-1,'autoplay',5,'bindchange',1,'class',2,'data-event-opts',3,'duration',4],[],e,s,gg)
var oTS=_v()
_(cSS,oTS)
var lUS=function(tWS,aVS,eXS,gg){
var oZS=_mz(z,'swiper-item',['bindtap',14,'class',1,'data-event-opts',2],[],tWS,aVS,gg)
var x1S=_n('image')
_rz(z,x1S,'src',17,tWS,aVS,gg)
_(oZS,x1S)
_(eXS,oZS)
return eXS
}
...
var a0S=_mz(z,'view',['bindtap',26,'class',1,'data-event-opts',2],[],e,s,gg)
var tAT=_n('image')
_rz(z,tAT,'src',29,e,s,gg)
_(a0S,tAT)
var eBT=_n('text')
var bCT=_oz(z,30,e,s,gg)
_(eBT,bCT)
_(a0S,eBT)
_(l9S,a0S)
var oDT=_mz(z,'view',['bindtap',31,'class',1,'data-event-opts',2],[],e,s,gg)
var xET=_n('image')
_rz(z,xET,'src',34,e,s,gg)
_(oDT,xET)
var oFT=_n('text')
var fGT=_oz(z,35,e,s,gg)
_(oFT,fGT)
_(oDT,oFT)
_(l9S,oDT)
var cHT=_mz(z,'view',['bindtap',36,'class',1,'data-event-opts',2],[],e,s,gg)
var hIT=_n('image')
_rz(z,hIT,'src',39,e,s,gg)
_(cHT,hIT)
var oJT=_n('text')
var cKT=_oz(z,40,e,s,gg)
_(oJT,cKT)
_(cHT,oJT)
_(l9S,cHT)
var oLT=_n('view')
...
var bQT=_mz(z,'view',['bindtap',45,'class',1,'data-event-opts',2],[],e,s,gg)
var oRT=_mz(z,'image',['class',48,'mode',1,'src',2],[],e,s,gg)
_(bQT,oRT)
var xST=_n('text')
_rz(z,xST,'class',51,e,s,gg)
var oTT=_oz(z,52,e,s,gg)
_(xST,oTT)
_(bQT,xST)
_(ePT,bQT)
var fUT=_mz(z,'scroll-view',['scrollX',-1,'class',53],[],e,s,gg)
var cVT=_n('view')
_rz(z,cVT,'class',54,e,s,gg)
var hWT=_v()
_(cVT,hWT)
var oXT=function(oZT,cYT,l1T,gg){
var t3T=_mz(z,'view',['bindtap',59,'class',1,'data-event-opts',2],[],oZT,cYT,gg)
var e4T=_n('view')
_rz(z,e4T,'class',62,oZT,cYT,gg)
var b5T=_mz(z,'image',['lazyLoad',-1,'binderror',63,'bindload',1,'class',2,'data-event-opts',3,'mode',4,'src',5],[],oZT,cYT,gg)
_(e4T,b5T)
_(t3T,e4T)
var o6T=_n('text')
_rz(z,o6T,'class',69,oZT,cYT,gg)
var x7T=_oz(z,70,oZT,cYT,gg)
_(o6T,x7T)
_(t3T,o6T)
var o8T=_n('text')
_rz(z,o8T,'class',71,oZT,cYT,gg)
var f9T=_oz(z,72,oZT,cYT,gg)
_(o8T,f9T)
_(t3T,o8T)
var c0T=_n('text')
_rz(z,c0T,'class',73,oZT,cYT,gg)
var hAU=_oz(z,74,oZT,cYT,gg)
_(c0T,hAU)
_(t3T,c0T)
_(l1T,t3T)
return l1T
...
hWT.wxXCkey=2
_2z(z,57,oXT,e,s,gg,hWT,'goods','index','index')
_(fUT,cVT)
_(ePT,fUT)
_(fOS,ePT)
var oBU=_v()
...
var eHU=_mz(z,'view',['bindtap',79,'class',1,'data-event-opts',2],[],lEU,oDU,gg)
var bIU=_n('image')
_rz(z,bIU,'src',82,lEU,oDU,gg)
_(eHU,bIU)
var oJU=_n('view')
_rz(z,oJU,'class',83,lEU,oDU,gg)
var xKU=_n('text')
_rz(z,xKU,'class',84,lEU,oDU,gg)
var oLU=_oz(z,85,lEU,oDU,gg)
_(xKU,oLU)
_(oJU,xKU)
_(eHU,oJU)
var fMU=_n('text')
_rz(z,fMU,'class',86,lEU,oDU,gg)
_(eHU,fMU)
_(aFU,eHU)
var cNU=_n('view')
_rz(z,cNU,'class',87,lEU,oDU,gg)
var hOU=_n('view')
_rz(z,hOU,'class',88,lEU,oDU,gg)
var oPU=_v()
_(hOU,oPU)
var cQU=function(lSU,oRU,aTU,gg){
var eVU=_mz(z,'view',['bindtap',93,'class',1,'data-event-opts',2],[],lSU,oRU,gg)
var bWU=_n('view')
_rz(z,bWU,'class',96,lSU,oRU,gg)
var oXU=_mz(z,'image',['lazyLoad',-1,'binderror',97,'bindload',1,'class',2,'data-event-opts',3,'mode',4,'src',5],[],lSU,oRU,gg)
_(bWU,oXU)
_(eVU,bWU)
var xYU=_n('text')
_rz(z,xYU,'class',103,lSU,oRU,gg)
var oZU=_oz(z,104,lSU,oRU,gg)
_(xYU,oZU)
_(eVU,xYU)
var f1U=_n('text')
_rz(z,f1U,'class',105,lSU,oRU,gg)
var c2U=_oz(z,106,lSU,oRU,gg)
_(f1U,c2U)
_(eVU,f1U)
var h3U=_n('text')
_rz(z,h3U,'class',107,lSU,oRU,gg)
var o4U=_oz(z,108,lSU,oRU,gg)
_(h3U,o4U)
_(eVU,h3U)
_(aTU,eVU)
return aTU
...
oPU.wxXCkey=2
_2z(z,91,cQU,lEU,oDU,gg,oPU,'goods','index2','index2')
_(cNU,hOU)
_(aFU,cNU)
return aFU
}
oBU.wxXCkey=2
_2z(z,77,cCU,e,s,gg,oBU,'mallGoods','index','index')
_(r,fOS)
return r
}
...
__wxAppCode__['pages/setting/about.wxss']=undefined;    
__wxAppCode__['pages/setting/about.wxml']=$gwx('./pages/setting/about.wxml');
